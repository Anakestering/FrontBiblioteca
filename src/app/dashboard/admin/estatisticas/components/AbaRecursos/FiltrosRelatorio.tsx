...
export function FiltrosRecursos({ salaIds, computadorIds, onChangeSalas, onChangePcs }: Props) {
          ...
          {dropdownPcs && (
            <div className="absolute top-full mt-1 left-0 z-20 w-52 card p-2 space-y-0.5 shadow-lg">
              <div className="flex justify-between px-2 py-1 mb-1">
                <button onClick={() => onChangePcs(computadores.map(c => c.id))} className="text-xs text-blue-600 hover:underline">Todos</button>
      ...
      {salas.length > 0 && (
        <div className="relative dropdown-recursos">
          ...
          {dropdownSalas && (
            <div className="absolute top-full mt-1 left-0 z-20 w-52 card p-2 space-y-0.5 shadow-lg">
              <div className="flex justify-between px-2 py-1 mb-1">
                <button onClick={() => onChangeSalas(salas.map(s => s.id))} className="text-xs text-blue-600 hover:underline">Todas</button>
