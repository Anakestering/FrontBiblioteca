...
function LoginForm() {
  ...
  useEffect(() => {
    if (searchParams.get('cadastro') === 'ok') {
      setToast('Cadastro realizado! Verifique seu email para criar sua senha.');
  ...
  return (
    <div className="w-full max-w-[420px] slide-in">
      ...
      {toast && (
        <div className="flex items-start gap-2.5 p-3 mb-4 rounded-lg bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800">
          <svg className="w-4 h-4 text-emerald-600 dark:text-emerald-400 shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
          </svg>
          <p className="text-sm text-emerald-700 dark:text-emerald-300">{toast}</p>
        </div>
      )}
